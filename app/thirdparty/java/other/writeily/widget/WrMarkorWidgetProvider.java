...
import net.gsantner.markor.activity.DocumentOpenerActivity;
...
public class WrMarkorWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            Intent openShare = new Intent(context, DocumentOpenerActivity.class)
            ...
            // Open To-do
            Intent openTodo = new Intent(context, DocumentOpenerActivity.class)
            ...
            // Open QuickNote
            Intent openQuickNote = new Intent(context, DocumentOpenerActivity.class)
                    .setAction(Intent.ACTION_EDIT)
            ...
            Intent openNoteIntent = new Intent(context, DocumentOpenerActivity.class);
